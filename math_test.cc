...
TEST(MyVectorTests, VectorLength3D) {
    Vector3df vector = {3.0, 4.0, 12.0}; // A 3D vector (3, 4, 12)

    // Calculate the expected length (magnitude) of the vector
    float expectedLength = 13.0; // sqrt(3^2 + 4^2 + 12^2) = 13.0

    // Calculate the actual length of the vector
    float actualLength = vector.length();

    // Use EXPECT_NEAR to check if the actual length is close to the expected length
    EXPECT_NEAR(actualLength, expectedLength, 0.00001);
}

TEST(MyVectorTests, VectorLength2D) {
    Vector2df vector = {0.0, 5.0};

    // Calculate the expected length (magnitude) of the vector
    float expectedLength = 5.0;
...
TEST(MyVectorTests, VectorSquareOfLength2D) {
    Vector2df vector = {0.0, 5.0};

    // Calculate the expected length (magnitude) of the vector
    float expectedLength = 25.0;

    // Calculate the actual length of the vector
    float actualLength = vector.square_of_length();

    // Use EXPECT_NEAR to check if the actual length is close to the expected length
    EXPECT_NEAR(actualLength, expectedLength, 0.00001);
}

TEST(MyVectorTests, VectorSquareOfLength3D) {
    Vector3df vector = {3.0, 4.0, 12.0};

    // Calculate the expected length (magnitude) of the vector
    float expectedLength = 169.0;
...
TEST(MyVectorTests, ScalarProduct2D) {
    Vector2df vector1 = {3.0, 4.0};
    Vector2df vector2 = {2.0, -1.0};

    // Calculate the expected scalar product
    float expectedScalarProduct = (3.0 * 2.0) + (4.0 * -1.0);

    // Calculate the actual scalar product
    float actualScalarProduct = vector1 * vector2;

    // Use EXPECT_NEAR to check if the actual scalar product is close to the expected scalar product
    EXPECT_NEAR(actualScalarProduct, expectedScalarProduct, 0.00001);
}

TEST(MyVectorTests, ScalarProduct3D) {
    Vector3df vector1 = {1.0, -2.0, 3.0};
    Vector3df vector2 = {2.0, 0.0, -1.0};

    // Calculate the expected scalar product
    float expectedScalarProduct = (1.0 * 2.0) + (-2.0 * 0.0) + (3.0 * -1.0);
