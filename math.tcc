...
//length Implementierung meinerseits
template <class FLOAT_TYPE, size_t N>
FLOAT_TYPE Vector<FLOAT_TYPE, N>::length() const {
    FLOAT_TYPE square_len = square_of_length();
    return std::sqrt(square_len);
}

//square of length Implementierung meinerseits
template <class FLOAT_TYPE, size_t N>
...
//berechnet Skalarprodukt zweier Vektoren
